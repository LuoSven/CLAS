...
namespace CLAS.Common
{
    public class ImgHelper
    {
        ...
        /// <returns></returns>
        List<NumBody> FindText(Bitmap subBitmap, Bitmap parBitmap, System.Drawing.Rectangle searchRect, byte errorRange, double matchRate = 0.9, bool isFindAll = false)
        {
        ...
        List<NumBody> FindText(string subPic, string parPic, System.Drawing.Rectangle searchRect, byte errorRange, double matchRate = 0.9, bool isFindAll = false)
        {
            ...
            return FindText(subBitmap,parBitmap, searchRect, errorRange, matchRate, isFindAll);
        }
        struct NumBody
        {
            public int num;//数字
